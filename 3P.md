...
| Item | Detail |
|---|---|
| Name | Qwen3-TTS (CustomVoice variant) |
| Hub ID | `Qwen/Qwen3-TTS-12Hz-0.6B-CustomVoice` (auto-fetched on first use, ~1.5 GB) |
| Type | Multilingual neural TTS with voice cloning — 0.6 B parameters, 9 preset speakers, 10 languages |
| License (code) | Apache 2.0 |
| License (weights) | Apache 2.0 |
| Source | https://github.com/Qwen/Qwen3-TTS |
| Obligation | Preserve Apache 2.0 NOTICE file and copyright headers if redistributing. |

### 2.8 VibeVoice-Realtime-0.5B *(under evaluation — not yet integrated, see `docs/issues/todo_006.md`)*

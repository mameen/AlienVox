...
def _restore_clipboard():
    ...
    from src.control.capture import _read_clipboard, _write_clipboard
...
def test_module_imports_on_windows():
    import src.control.capture  # noqa: F401 — import must succeed on Windows


def test_get_selected_text_returns_string():
    """get_selected_text() must always return str, never raise."""
    from src.control.capture import get_selected_text
